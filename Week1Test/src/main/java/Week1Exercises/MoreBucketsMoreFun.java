...
public class MoreBucketsMoreFun {
    public static void main(String[] args) {
        ...
        butterflies--;
        // we are using the decrement operator
        // however, since Java is a pass by value language and we assigned bugs to the
        // value extracted from butterflies and beetles, bugs is unaffected by the change
